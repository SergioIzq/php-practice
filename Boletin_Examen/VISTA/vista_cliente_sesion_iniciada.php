...
<body>
    ...
    <div class="containerRegistro">
        <div class="tituloRegistro">
            <h2>Bienvenido {{ correo sacado de la base de datos }}</h2>
        </div>
        <div class="p-central">
        ...
        <div class="buttons-user">
            ...
            <button class="button-registrarse"><a href="">Hacer Nueva Reserva</a></button>
            <button class="button-registrarse"><a href="">Ver Histórico de Reservas</a></button>
        </div>
    </div>
